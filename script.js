const term =  $('body').terminal({
    q: function() {
         term.read('> ', question => {
            ...
            else if(question == 'hello' || question == 'Hello') {
                this.echo('Hello, my student. What can I teach you today? [[ x ]]', { typing: true, delay: 75 });
            }
            else if(question == 'roll' || question == 'Roll') {
                this.echo('https://www.youtube.com/watch?v=dQw4w9WgXcQ [[ x ]]', { typing: true, delay: 75 });
            }
            else {
                this.echo('Unknown input...[[ x ]]', { typing: true, delay: 75 });
            }
        })
    },
    x: function() {
        term.read('> ', question => {
           if(question == 'Who are you?' || question == 'who are you?' || question == 'Who are you' || question == 'who are you') {
               ...
               this.echo('Unknown input...[[ q ]]', { typing: true, delay: 75 });
           }
       })
   },
}, 
